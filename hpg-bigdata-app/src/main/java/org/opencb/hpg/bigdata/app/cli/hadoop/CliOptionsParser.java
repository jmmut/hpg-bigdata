...
//        convertCommandOptions = new ConvertCommandOptions();
    ...
    public class IbsVariantCommandOptions {
        ...
        @Parameter(names = {"-f", "--inputType"}, description = "Type of the input {file, hbase} (see \"-i\").", required = true, arity = 1)
        ...
        public String input = null;
        @Parameter(names = {"-s", "--spark-home"}, description = "path to the spark installation that SparkLauncher will use.", required = false, arity = 1)
        public String sparkHome = null;
        @Parameter(names = {"-j", "--jar"}, description = "AppResource (path to the jar) that SparkLauncher will use.", required = false, arity = 1)
        ...
        public String output = "null";
        @Parameter(names = {"-c", "--connector"}, description = "Connector class name. Will use reflection to retrieve the input", required = false, arity = 1)
